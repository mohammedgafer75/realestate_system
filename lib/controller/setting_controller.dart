          ...
          child: DialogButton(
            onPressed: () async {
              ...
              try{
                ...
                Get.back();
                Get.back();
                Get.snackbar('Update Name', 'Name Updated',backgroundColor: Colors.greenAccent);
              }catch(e){
                Get.back();
                Get.back();
          ...
          DialogButton(
            onPressed: () async {
              ...
              try {
                ...
                Get.back();
                Get.back();
                Get.snackbar('Update Email', 'your email is updated',backgroundColor: Colors.greenAccent);
              } on auth
